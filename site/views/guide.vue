<template>
  <div class="page">
    ...
    <div class="wrap">
      <!-- slide -->
      <Side :side-list="sideList" :current-route="currentRoute" @handleSideClick="handleSideClick"></Side>
      <!-- main -->
      <div ref="main" class="main">
        <!-- content -->
        <Markdown :ui-name="currentRoute.name"></Markdown>
      </div>
      <!-- ui -->
      <UiPreview v-if="currentRoute.showMobile" :ui-path="uiPath" :ui-title="currentRoute.title"></UiPreview>
    </div>
  </div>
</template>
